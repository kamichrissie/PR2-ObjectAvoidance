...
public:
  ...
  double* ellipses_coordinates(double px, double py, double alpha, double r1, double r2);

  //Ellipsen übergeben
  double** ellipses_pass(const std::vector<Line>&);
...
private:
  ...
  //double* ellipses_coordinates( double, double, double, double, double);
};
